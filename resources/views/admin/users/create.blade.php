...
<div class="min-h-screen">
    ...
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-[#1D433F] font-lora mb-2">Add New User</h1>
        <p class="text-gray-600 font-cg">Create a new user account</p>
    </div>
 ...
 -->    
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
                <h3 class="text-lg font-bold text-[#1D433F] font-lora mb-4">Set Password</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1 font-cg">Minimum 8 characters</p>
                        @error('password')
                        <p class="text-red-500 text-xs mt-1 font-cg">{{ $message }}</p>
                        @enderror
                    </div>
